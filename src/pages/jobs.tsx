      ...
      <div className="cp-grid cp-about__skills" id="jr">
        ...
        <div className="cp-grid__container">
          ...
          <h4><span>Cosa offriamo?</span></h4> 
            ...
            <br/>
            <a title="Invia una candidatura" id="jobs__junior" className="cp-about__button" href="mailto:jobs@codiceplastico.com?subject=Candidatura%20DevTeam%20CodicePlastico"> <span>Invia la tua candidatura!</span></a>
            <div><p><strong>Vuoi conoscerci meglio?</strong> Puoi scoprire <a href="https://codiceplastico.com/">come lavoriamo</a>, conoscere il <a href="https://codiceplastico.com/team/">Team</a> e vedere come è la vita in <a href="https://blog.codiceplastico.com/categories/vita-plastica">CodicePlastico</a>.</p></div>
          </div>
        </div>
      </div>    
