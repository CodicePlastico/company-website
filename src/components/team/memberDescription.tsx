...
const MemberDescription = (props: MemberDescriptionProps) => {
  ...
  return (
    <section className={descriptionClass} style={memberStyle} onClick={handleClick}>
        <button className="cp-member__description-close" onClick={toggleDescription} aria-label="chiudi descrizione membro del team">
        ...
        <div className="cp-member__description-info">
          <h2 className="cp-member__description-title">{member.name}</h2>
