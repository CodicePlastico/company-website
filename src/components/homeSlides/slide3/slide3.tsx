      ...
      <div className="cp-grid cp-home__grid">
        <div className="cp-grid__container cp-home__grid-container">
          <div className="cp-grid__content">
            <h2 className="cp-home__title cp-slide-2__title">
              <span>
                L'altra metà della <strong>mela</strong>
              </span>
            </h2>
            <p>
              Ogni progetto inizia con una <strong>stretta di mano</strong>,
              reale o virtuale poco importa.
              <br />
              In CodicePlastico collaboriamo con aziende che condividono il
              nostro <strong>metodo</strong>
              <br />e i nostri <strong>valori</strong>: conoscerci
              reciprocamente è importante.
            </p>
          </div>
        </div>
      </div>
