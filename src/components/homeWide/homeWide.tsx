  ...
  return (
    <div className='cp-home-wide'>
      <div className='cp-home-wide__section cp-home-wide__section__tech'>
        <div className='cp-home-wide__section__tech__header'></div>
        <div className='cp-home-wide__section__tech__sidebar'></div>
      ...
      <div className='cp-home-wide__section cp-home-wide__section__apple'>
        <div className='cp-home-wide__section__apple__header'></div>
        ...
        <div className='cp-home-wide__section__apple__footer'></div>
      </div>
      <div className='cp-home-wide__section cp-home-wide__section--red cp-home-wide__section__tailor'>
        <div className='cp-home-wide__section__tailor__header'></div>
        <div className='cp-home-wide__section__tailor__sidebar'></div>
        ...
        <div className='cp-home-wide__section__tailor__footer'></div>
      </div>
      <div className='cp-home-wide__section cp-home-wide__section__analysis'>
        <div className='cp-home-wide__section__analysis__header'></div>
        ...
        <div className='cp-home-wide__section__analysis__sidebar'></div>
      </div>
      <div className='cp-home-wide__section cp-home-wide__section__compass'>
        ...
        <div className='cp-home-wide__section__compass__sidebar-right'></div>
        <div className='cp-home-wide__section__compass__middle'></div>
        <div className='cp-home-wide__section__compass__sidebar-left'></div>
      ...
      <div className='cp-home-wide__section cp-home-wide__section__basement'>
        <div className='cp-home-wide__section__basement__sidebar'></div>
        ...
        <div className='cp-home-wide__section__basement__footer'></div>
      </div>
      <div className='cp-home-wide__section cp-home-wide__section--red cp-home-wide__section__code'>
        <div className='cp-home-wide__section__code__header'></div>
        ...
        <div className='cp-home-wide__section__code__sidebar'></div>
      </div>
      <div className='cp-home-wide__section cp-home-wide__section__changes'>
        <div className='cp-home-wide__section__changes__sidebar-left'></div>
        ...
        <div className='cp-home-wide__section__changes__sidebar-right'></div>
      </div>
